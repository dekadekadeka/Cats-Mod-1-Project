...
paul = Cat.create(name: "Paul", breed: "Domestic Shorthair", color: "black and white", favorite_food: "wet", temperament: true, neighborhood_id: west_end.id, owner_id: deka.id)
